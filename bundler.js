...
export async function bundleInstall(gemfile, lockFile, platform, engine, rubyVersion, bundlerVersion, cacheVersion, deployment) {
  if (gemfile === null) {
  ...
  if (fs.existsSync(lockFile)) {
    for (var i = 0; i < 100; i++) {
      console.log(`Deployment value: ${deployment}`)
    }
